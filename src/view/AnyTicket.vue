...
<el-row :gutter="10">
  ...
  <el-col class="cols" :span="4">
    <div id="price">￥{{ticket.coun*price/100}}</div>
  </el-col>
  ...
  <el-col class="cols" :span="3">
    <span ><el-button style="border-color: #8d9fb7" type="info" @click="pay(ticket.ticket_id,ticket.coun*price/100+190)">预订</el-button></span>
  </el-col>
